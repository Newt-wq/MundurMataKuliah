      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center border-b border-slate-200 pb-4 gap-3 print:hidden">
        ...
        <div className="flex gap-2 w-full sm:w-auto">
          ...
          <Link
            ...
            className="flex-1 sm:flex-initial inline-flex items-center justify-center gap-1.5 bg-primary-madani hover:bg-primary-madani-dark text-white font-semibold py-2 px-4 rounded text-xs transition-colors cursor-pointer shadow-sm"
          >
